...
public class NfeRecepcao2Stub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService("NfeRecepcao2"
				+ getUniqueSuffix());
	 ...
	 */
	public NfeRecepcao2Stub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
	 ...
	 * 
	 * @see br.com.abril.nfe.integracao.NfeRecepcao2#nfeRecepcaoLote2
	 * @param nfeDadosMsg0
	 * 
	 * @param nfeCabecMsg1
	 */

	public br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeRecepcaoLote2Result nfeRecepcaoLote2(

			br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeDadosMsg nfeDadosMsg0,
			br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeCabecMsgE nfeCabecMsg1)
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(
					...
					br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeRecepcaoLote2Result.class,
					getEnvelopeNamespaces(_returnEnv));

			return (br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeRecepcaoLote2Result) object;
			...
			if (faultElt != null) {
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(
								faultElt.getQName(), "nfeRecepcaoLote2"))) {
	 ...
	 * 
	 * @see br.com.abril.nfe.integracao.NfeRecepcao2#startnfeRecepcaoLote2
	 * @param nfeDadosMsg0
	 * 
	 * @param nfeCabecMsg1
	 */
	public void startnfeRecepcaoLote2(
			...
			final br.com.abril.nfe.integracao.NfeRecepcao2CallbackHandler callback)
	...
	throws java.rmi.RemoteException {
		...
		env = toEnvelope(getFactory(_operationClient.getOptions()
				.getSoapVersionURI()), nfeDadosMsg0,
				optimizeContent(new javax.xml.namespace.QName(
						"http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2",
						"nfeRecepcaoLote2")), new javax.xml.namespace.QName(
						"http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2",
						"nfeRecepcaoLote2"));
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback.receiveResultnfeRecepcaoLote2((br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeRecepcaoLote2Result) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap
									...
									try {
										...
										callback.receiveErrornfeRecepcaoLote2(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
	...
	public static class NfeDadosMsg implements
		...
		private static java.lang.String generatePrefix(
			...
			if (namespace
					.equals("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2")) {
				return "";
			}
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(
			...
			if ("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2"
	...
	public static class NfeCabecMsg implements
		 ...
		 * http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2 Namespace Prefix
		 * =
		 */
	...
	public static class NfeRecepcaoLote2Result implements
			org.apache.axis2.databinding.ADBBean {
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "nfeRecepcaoLote2Result", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static NfeRecepcaoLote2Result parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				NfeRecepcaoLote2Result object = new NfeRecepcaoLote2Result();
						...
						if (fullTypeName != null) {
							...
							if (!"nfeRecepcaoLote2Result".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (NfeRecepcaoLote2Result) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	private org.apache.axiom.om.OMElement toOM(
			br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeDadosMsg param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeDadosMsg.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeRecepcaoLote2Result param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeRecepcaoLote2Result.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeCabecMsgE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeDadosMsg.class
					.equals(type)) {

				return br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeRecepcaoLote2Result.class
					.equals(type)) {

				return br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeRecepcaoLote2Result.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeCabecMsgE.class
					.equals(type)) {

				return br.com.abril.nfe.integracao.NfeRecepcao2Stub.NfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
