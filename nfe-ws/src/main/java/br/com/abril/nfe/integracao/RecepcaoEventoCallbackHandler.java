...
/**
 * RecepcaoEventoCallbackHandler Callback class, Users can extend this class and
...
public abstract class RecepcaoEventoCallbackHandler {
	 ...
	 * override this method for handling normal response from nfeRecepcaoEvento
	 * operation
	 */
	public void receiveResultnfeRecepcaoEvento(
			br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from nfeRecepcaoEvento operation
	 */
