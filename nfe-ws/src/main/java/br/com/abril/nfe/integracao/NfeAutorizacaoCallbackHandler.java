...
/**
 * NfeAutorizacaoCallbackHandler Callback class, Users can extend this class and
...
public abstract class NfeAutorizacaoCallbackHandler {
	...
	public void receiveResultnfeAutorizacaoLoteZip(
			br.com.abril.nfe.integracao.NfeAutorizacaoStub.NfeAutorizacaoLoteZipResult result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from nfeAutorizacaoLoteZip operation
	 */
	 ...
	 * override this method for handling normal response from nfeAutorizacaoLote
	 * operation
	 */
	public void receiveResultnfeAutorizacaoLote(
			br.com.abril.nfe.integracao.NfeAutorizacaoStub.NfeAutorizacaoLoteResult result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from nfeAutorizacaoLote operation
	 */
