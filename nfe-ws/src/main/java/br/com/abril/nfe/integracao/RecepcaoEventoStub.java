...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService(
				"RecepcaoEvento" + getUniqueSuffix());
	 ...
	 */
	public RecepcaoEventoStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
	 ...
	 * 
	 * @see br.com.abril.nfe.integracao.RecepcaoEvento#nfeRecepcaoEvento
	 * @param nfeDadosMsg0
	 * 
	 * @param nfeCabecMsg1
	 */

	public br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult nfeRecepcaoEvento(

			br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg0,
			br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeCabecMsgE nfeCabecMsg1)
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(
					...
					br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult.class,
					getEnvelopeNamespaces(_returnEnv));

			return (br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult) object;
	 ...
	 * 
	 * @see br.com.abril.nfe.integracao.RecepcaoEvento#startnfeRecepcaoEvento
	 * @param nfeDadosMsg0
	 * 
	 * @param nfeCabecMsg1
	 */
	public void startnfeRecepcaoEvento(
			...
			final br.com.abril.nfe.integracao.RecepcaoEventoCallbackHandler callback)
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback.receiveResultnfeRecepcaoEvento((br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult) object);
	...
	public static class NfeDadosMsg implements
		...
		private static java.lang.String generatePrefix(
			...
			if (namespace
					.equals("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento")) {
				return "";
			}
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(
			...
			if ("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento"
	...
	public static class NfeRecepcaoEventoResult implements
			org.apache.axis2.databinding.ADBBean {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							...
							"type", namespacePrefix
									+ ":nfeRecepcaoEventoResult", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "nfeRecepcaoEventoResult", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static NfeRecepcaoEventoResult parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				NfeRecepcaoEventoResult object = new NfeRecepcaoEventoResult();
						...
						if (fullTypeName != null) {
							...
							if (!"nfeRecepcaoEventoResult".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (NfeRecepcaoEventoResult) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class NfeCabecMsg implements
		 ...
		 * http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento Namespace
		 * Prefix =
		 */
	...
	private org.apache.axiom.om.OMElement toOM(
			br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeDadosMsg param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeDadosMsg.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeCabecMsgE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeDadosMsg.class
					.equals(type)) {

				return br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult.class
					.equals(type)) {

				return br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeRecepcaoEventoResult.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeCabecMsgE.class
					.equals(type)) {

				return br.com.abril.nfe.integracao.RecepcaoEventoStub.NfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
