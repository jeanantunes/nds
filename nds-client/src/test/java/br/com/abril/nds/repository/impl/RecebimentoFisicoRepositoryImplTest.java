...
public class RecebimentoFisicoRepositoryImplTest extends AbstractRepositoryImplTest{
	...
	public void setup() {
		...
		tipoProduto = Fixture.tipoProduto("Revista", GrupoProduto.REVISTA, "99000642", null, 13L);
		save(tipoProduto);
		
		Editor abril = Fixture.editoraAbril();
		save(abril);
		
		produto = Fixture.produto("1", "Revista Veja", "Veja", PeriodicidadeProduto.SEMANAL, tipoProduto, 5, 5, BigDecimal.TEN);
