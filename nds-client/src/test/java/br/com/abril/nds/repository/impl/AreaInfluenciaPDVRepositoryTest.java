...
public class AreaInfluenciaPDVRepositoryTest extends AbstractRepositoryImplTest {
	...
	public void obterAreaInfluenciaPDV(){
		...
		List<AreaInfluenciaPDV> areas = areaInfluenciaPDVRepository.obterAreaInfluenciaPDV(areaInfluenciaPDV.getCodigo(),
