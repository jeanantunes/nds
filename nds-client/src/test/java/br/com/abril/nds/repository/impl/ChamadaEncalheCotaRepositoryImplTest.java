...
public class ChamadaEncalheCotaRepositoryImplTest extends AbstractRepositoryImplTest {
	...
	public void setUpGeral() {
		...
		ProdutoEdicao infoExame3 = Fixture.produtoEdicao(3L, 5, 30,
				new BigDecimal(0.1), BigDecimal.TEN, new BigDecimal(12), "ABCDGHIJKLMNOPQRSTU", 3L, infoExame);
		infoExame3.setDesconto(BigDecimal.ZERO);

		ProdutoEdicao capricho1 = Fixture.produtoEdicao(1L, 10, 15,
				new BigDecimal(0.12), BigDecimal.TEN, BigDecimal.TEN, "ABCDEFGHIJKLMNU", 4L, capricho);
		capricho1.setDesconto(BigDecimal.ZERO);
		
		ProdutoEdicao cromoReiLeao1 = Fixture.produtoEdicao(1L, 100, 60,
				new BigDecimal(0.01), BigDecimal.ONE, new BigDecimal(1.5), "ABCTU", 5L, cromoReiLeao);
