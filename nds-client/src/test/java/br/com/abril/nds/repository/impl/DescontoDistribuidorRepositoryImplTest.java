...
public class DescontoDistribuidorRepositoryImplTest extends AbstractRepositoryImplTest{
	...
	public void setup() {
		...
		DescontoDistribuidor desconto2 = Fixture.descontoDistribuidor(new BigDecimal(2), distribuidor, fornecedores, usuario);
		
		Set<Fornecedor> fornecedores2 = new HashSet<Fornecedor>();
		fornecedores2.add(fornecedor);
		fornecedores2.add(fornecedor1);
		DescontoDistribuidor desconto3 = Fixture.descontoDistribuidor(new BigDecimal(3), distribuidor, fornecedores2, usuario);
		...
		DescontoDistribuidor desconto4 = Fixture.descontoDistribuidor(new BigDecimal(4), distribuidor, fornecedores3, usuario);
