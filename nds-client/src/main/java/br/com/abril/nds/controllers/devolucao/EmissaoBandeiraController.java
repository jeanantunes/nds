...
public class EmissaoBandeiraController extends BaseController {
	...
	private TableModel<CellModelKeyValue<BandeirasDTO>> efetuarConsultaBandeirasDaSemana(Date dataEmissao, Long fornecedor, Long numeroNotaDe, Long numeroNotaAte, PaginacaoVO paginacao) {
