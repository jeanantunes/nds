...
//		List<AjusteReparteDTO> cotasEmAjuste = ajusteService.buscarCotasEmAjuste();
		
		TableModel<CellModelKeyValue<RegiaoCotaDTO>> tableModel = montarCotasEmAjuste();
		
		result.use(Results.json()).withoutRoot().from(tableModel).recursive().serialize();
	}
	
	private TableModel<CellModelKeyValue<RegiaoCotaDTO>> montarCotasEmAjuste () {
