...
public class MatrizDistribuicaoController extends BaseController {
	...
	if (dataPesquisa == null) {
	    listaMensagens.add("O preenchimento do campo [Data] Ã© obrigatÃ³rio!");
	}
    ...
    /**
     * ObtÃ©m o filtro para pesquisa da sessÃ£o.
     * 
     * @return filtro
     */
	...
	if (filtro == null) {
	    throw new ValidacaoException(TipoMensagem.ERROR, "SessÃ£o expirada!");
	}
	return filtro;
    }
	...
	try {
	    ...
	    log.error("Erro na geraÃ§Ã£o automatica do estudo.", e);
