...
//	                    rowNumeroEdicao.eq(key+1).text(value.edicao + (result.list[key].parcial ? ' / Período: ' + result.list[key].numeroPeriodo : ''));
//	                    rowDataLancamento.eq(key+1).text(result.list[key].dataLancamentoFormatada);
//	                    rowReparte.eq(key+1).text(result.list[key].reparte*1 || 0);
//	                    rowVenda.eq(key+1).text(result.list[key].venda*1 || 0);
//                	}
//                });
//            });
//        }
