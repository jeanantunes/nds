	...
	getDataFromResult : function(data) {
		...
		if(typeof data.mensagens == "object") {
			...
			$.each(data.rows, function(index, value) {			
				...
				value.cell.valorPostergado = (value.cell.valorPostergado != null && value.cell.valorPostergado > 0)?'<span class="bt_tool"><a rel="tipsy" title="Valor Referente à '+dataRaizPostergado+'">' +
					floatToPrice(formatMoneyValue(value.cell.valorPostergado)) + '</a></span>' : '0,00';
				
				value.cell.pendente = (value.cell.pendente != null && value.cell.pendente > 0)?'<span class="bt_tool"><a rel="tipsy" title="Valor Referente à '+dataRaizPendente+'">' +
