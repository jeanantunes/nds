...
<table width="280" cellpadding="2" cellspacing="2" style="text-align: left;">
	...
	<tr>
		<td>&nbsp;</td>
		<td><span class="bt_novos"><a id="fiadorController-cotasAssociadas-adicionarCotaAssociacao" isEdicao="true" rel="tipsy" title="Associar Nova Cota" href="javascript:fiadorController.adicionarAssociacaoCota();"><img src="${pageContext.request.contextPath}/images/ico_add.gif" hspace="5" border="0"/></a></span></td>
	</tr>
</table>
</fieldset>
