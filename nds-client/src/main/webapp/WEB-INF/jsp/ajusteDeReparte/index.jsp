...
<body>
	...
	<div id="dialog-novo" title="Novo Ajuste">
		<fieldset style="width: 585px !important;">
			...
			<table width="575" border="0" cellspacing="1" cellpadding="2">
				<tr>
					...
					<td width="30">Nome:</td>
					<td width="398"><input type="text" style="width: 160px;" /></td>
				</tr>
			</table>
			<table width="575" border="0" cellspacing="1" cellpadding="2">
				<tr>
				...
				<tr>
					<td width="20"><input type="radio" name="radio" id="radio2"
						value="radio"
						onclick="$('.vdaMedia').hide();$('.vlrPerc').toggle();$('.ajusteSeg').hide();$('.encalheMaximo').hide();" /></td>
					<td width="102">Ajuste Histórico</td>
					<td width="20"><input type="radio" name="radio" id="radio3"
						value="radio"
						onclick="$('.vdaMedia').show();$('.vlrPerc').hide();$('.ajusteSeg').hide();$('.encalheMaximo').hide();" /></td>
					<td width="88">Venda Média +</td>
					<td width="20"><input type="radio" name="radio" id="radio"
						value="radio"
						onclick="$('.vdaMedia').hide();mostrarSegmentos(); $('.vlrPerc').hide();$('.encalheMaximo').hide();" /></td>
					<td width="125">Ajuste por Segmento</td>
					<td width="20"><input type="radio" name="radio" id="radio4"
						value="radio"
						onclick="$('.vdaMedia').hide();$('.encalheMaximo').toggle(); $('.ajusteSeg').hide(); $('.vlrPerc').hide();" /></td>
			...
			<table width="575" border="0" cellspacing="1" cellpadding="2">
				<tr>
					...
					<td width="125"></td>
					<td width="20"></td>
					<td width="139"><span class="encalheMaximo"
			...
			<table width="575" border="0" cellspacing="1" cellpadding="2"
				...
				<tr>
					...
					<td width="30">999</td>
					<td width="20"><img src="../images/ico_excluir.gif"
						alt="Excluir" border="0" /></td>
					<td width="110">Segmento2</td>
					<td width="30">999</td>
					<td width="15"><img src="../images/ico_excluir.gif"
						alt="Excluir" border="0" /></td>
			...
			<table width="575" border="0" cellpadding="2" cellspacing="1">
				<tr>
					...
					<td width="466"><select name="select2" id="select2"
						style="width: 200px;">
							<option selected="selected">Selecione...</option>
							<option>Inadimplência</option>
							<option>Reforma</option>
							<option>Venda do PDV</option>
							<option>Doença</option>
							<option>Incidentes</option>
							<option>Recesso Estudantil</option>
							<option>Solicitação do Jornaleiro</option>
							<option>Outros</option>
					</select></td>
				</tr>
				<tr>
					<td>Período:</td>
					<td><table width="293" border="0" cellspacing="0"
							cellpadding="0">
							<tr>
								<td width="293"><input type="text" name="periodo1"
									id="periodo1" style="width: 60px;" /> &nbsp;&nbsp;Até <input
									type="text" name="periodo2" id="periodo2" style="width: 60px;" /></td>
							</tr>
						</table></td>
				</tr>
			</table>
			...
			<div class="sub-header">
				...
				<div id="div_acessoRapido" class="box_acesso_rapido">
					<span class="titulo"><a href="javascript:;"
						onclick="acessoRapido();" style="float: left;">Acesso Rápido</a></span> <a
						href="javascript:;" onclick="acessoRapidoFechar();"
				...
				<div class="porSegmento" style="display: block;">
					...
					<fieldset class="classFieldset">
						...
						<span class="bt_novos" title="Novo"><a href="javascript:;"
							onclick="incluirAjuste();"><img
								src="../images/ico_salvar.gif" hspace="5" border="0" />Novo</a></span> <span
							class="bt_novos" title="Gerar Arquivo"><a
      ...
      <span class="bt_novos" title="Confirmar" style="float:right;"><a href="javascript:;"><img src="../images/ico_check.gif" hspace="5" border="0" />Confirmar</a></span>
				...
				<div class="porCota" style="display: none;">
					...
					<fieldset class="classFieldset"
						...
						<span class="bt_novos" title="Confirmar" style="float: right;"><a
							href="javascript:;"><img src="../images/ico_check.gif"
								hspace="5" border="0" />Confirmar</a></span>
