...
<table width="850" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="26" colspan="4" style="border-left:1px solid #000; border-bottom:1px solid #000;"><span class="dadosNota"><font size="2"><b>${dadosDistribuidor.razaoSocial}</b></font></span></td>
