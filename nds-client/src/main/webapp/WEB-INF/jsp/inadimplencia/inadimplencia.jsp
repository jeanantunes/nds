...
<input type="checkbox" id="idSelecaoTodos" name="Todos2" onclick="inadimplenciaController.selecionarTodos(this);" style="float:left;" checked="checked" />
					</span>
				</td>
				<td>
					<span class="bt_sellAll">
...
<!-- SITUACAO DIVIDA - ABERTAS -->
				<td>
<input id="idDividaEmAberto" name="checkgroup_menu_divida" onclick="verifyCheck($('#idSelecaoTodos'));" type="checkbox" checked="checked" />
                </td>
                <td>
...
<input id="idDividaNegociada" name="checkgroup_menu_divida" onclick="verifyCheck($('#idSelecaoTodos'));" type="checkbox" checked="checked" />
				</td>
				<td>
...
<input id="idDividaPaga" name="checkgroup_menu_divida" onclick="verifyCheck($('#idSelecaoTodos'));" type="checkbox" checked="checked" />
				</td>
				<td>
