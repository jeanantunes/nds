...
<body>
		...
		<fieldset class="classFieldset">
			...
			<table width="950" border="0" cellpadding="2" cellspacing="1"
				...
				<tr>
					...
					<td width="108"><span class="bt_pesquisar"><a href="javascript:;" onclick="bancoController.mostrarGridConsulta();">Pesquisar</a>
					</span>
					</td>
				</tr>
			</table>
	...
	<div class="linha_separa_fields">&nbsp;</div>
		...
		<fieldset class="classFieldset">
			...
			<span class="bt_novo"><a href="javascript:;" onclick="bancoController.popup();">Novo</a>
			</span>
