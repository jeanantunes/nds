...
<div class="corpo">
	...
	<div id="dialog-excluir " title="Excluir RegiÃ£o">
		<p>Confirma a exclusÃ£o desta RegiÃ£o?</p>
	</div>
	</form>
	 -->
	...
	<div id="dialog-confirmacao" title="Inserir cota" style="display: none;">
		<p>Confirma a inserÃ§Ã£o destas cotas na regiÃ£o?</p>
	</div>
	</form>
		...
		<fieldset style="width: 600px !important;">
			...
			<table width="588" border="0" cellspacing="2" cellpadding="2">
				<tr>
					...
					<td width="68">ClassificaÃ§Ã£o:</td>
					<td width="163"><select name="select" id="select"
						style="width: 140px;">
							<option selected="selected">Selecione...</option>
							<option>ClassificaÃ§ao 1</option>
							<option>ClassificaÃ§Ã£o 2</option>
							<option>ClassificaÃ§Ã£o 3</option>
							<option>ClassificaÃ§Ã£o 4</option>
					</select>
					</td>
					<td width="31"><span title="Pesquisar Produto"
	...
	<!-- REGIÃƒO AUTOMÃTICA -->
	<div id="dialog-cotas" title="Montagem de RegÃ£o AutomÃ¡tica"
		style="display: none;">
		<fieldset style="width: 600px !important;">
			<legend>Montar RegiÃ£o por:</legend>
			...
			<!-- REGIAO AUTOMÃTICA - POR SEGMENTO -->
		...
		<!-- REGIAO AUTOMÃTICA - POR CEP - GRID -->
		...
		<!-- REGIAO AUTOMÃTICA - POR N-MAIORES -->
	...
	<div id="dialog-lote" title="Adicionar em Lote" style="display: none;">
		<fieldset style="width: 225px;">
			...
			<table width="200" border="0" cellspacing="2" cellpadding="2">
				<tr>
					<td width="44">NÂ° cota: <textarea rows="4" cols="30" > </textarea> 
	...
	<!-- REGIÃƒO AUTOMÃTICA - MONTAGEM DA REGIAO -->

	<div id="dialog-regiaoAutomatica" title="Montagem RegiÃ£o AutomÃ¡tica"
		style="display: none;">
		<fieldset style="width: 400px !important;">
			<legend>Adicionar Cotas</legend>
			<table class="regioesCadastradasGrid"></table>
		...
		<fieldset style="width: 400px !important; margin-top: 5px;">
			...
			<span class="bt_novos"><a href="javascript:;"
				onclick="regiaoController.addNovaRegiao();"><img
					src="${pageContext.request.contextPath}/images/ico_add.gif" hspace="5" border="0" />Nova RegiÃ£o</a> </span>
		</fieldset>
	</div>
	...
	<div id="dialog-novo" title="RegiÃµes Cadastradas" style="display: none;">
		<fieldset style="width: 600px !important;">
			<legend>RegiÃµes Cadastradas</legend>
			<table class="regioesCadastradasGrid">
			<!-- <span class="bt_novos"><a href="javascript:;" onclick="addNovaRegiao();"><img src="../images/ico_add.gif" hspace="5" border="0" />Nova RegiÃ£o</a></span>-->
			</table>
		</fieldset>
	</div>
	...
	<div id="dialog-addRegiao" title="Nova RegiÃ£o" style="display: none;">
		<fieldset style="width: 300px !important;">
			<legend>RegiÃ£o</legend>
			<table width="270" border="0" cellspacing="2" cellpadding="2">
				<tr>
					<td width="44">Nome:</td>
	...
	<div id="dialog-excluirCota" title="Excluir Cota" style="display:none;">
		<p>Confirma a exclusÃ£o desta Cota?</p>
	</div>
	
	<div id="dialog-alterarRegiao" title="Alterar RegiÃ£o" style="display:none;">
		<p>Confirma a alteraÃ§Ã£o desta RegiÃ£o?</p>
	</div>
			<!-- 
			<div id="effect" style="padding: 0 .7em;"
				class="ui-state-highlight ui-corner-all">
	...
	<div id="dialog-editar" title="Editar regiÃ£o">
	</div>

			<!-- COMBO DE REGIÃ•ES -->
			
			<fieldset class="classFieldset">
				<legend> Pesquisar RegiÃ£o</legend>
				<table width="950" border="0" cellpadding="2" cellspacing="1" class="filtro">
					<tr>
						<td width="48">RegiÃ£o:</td>
						<td width="752">
						...
						<td width="134"><span class="bt_novos" title="Nova RegiÃ£o"><a
								href="javascript:;" onclick="regiaoController.addNovaRegiao();"><img
									src="${pageContext.request.contextPath}/images/ico_salvar.gif" hspace="5" border="0" />Nova	RegiÃ£o</a> </span>
						</td>
					</tr>
				</table>
			</fieldset>
		...
		<!-- COTAS DA REGIAO -->			
			...
			<div class="grids" style="display: none;">
				<fieldset class="classFieldset">
					<legend>Cotas por RegiÃ£o</legend>

					<table class="cotasRegiaoGrid"></table>
					
						<!-- BOTÃ•ES GRID PRINCIPAL -->
					...
					<span class="bt_novos" title="RegiÃ£o AutomÃ¡tica">
					...
					<span class="bt_novos" title="ManutenÃ§Ã£o">
