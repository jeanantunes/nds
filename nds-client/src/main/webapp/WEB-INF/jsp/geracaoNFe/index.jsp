...
<div id="geracaoNfe-dialog-cotasSuspensasConfirmar"
	title="Transfer√™ncia para Suplementar">
	<form>
		<fieldset>
			<legend>Transfer√™ncia para Suplementar</legend>
			<p>O reparte das cotas selecionadas ser√£o transferidos para Suplementar</p>
		</fieldset>
	</form>
</div>
<div class="areaBts">
	<div class="area">
		...
		<span class="bt_arq">
			<a href="javascript:;" id="geracaoNfe-btnRelatorioXLS" rel="tipsy" title="ExtraÁ„o Relatorio Fiscal EXCEL">
				<img src="${pageContext.request.contextPath}/images/ico_excel.png" hspace="5" border="0" />
			</a>
		</span>
		<span class="bt_arq">
		...
		<span class="bt_arq">
			<a href="javascript:;" id="geracaoNfe-btnRelatorioPDF" rel="tipsy" title="ExtraÁ„o Relatorio Fiscal PDF">
				<img src="${pageContext.request.contextPath}/images/ico_impressora.gif" alt="ExtraÁ„o Relatorio Fiscal" hspace="5" border="0" />
			</a>
		</span>
	</div>
</div>
		...
		<table width="1000px" border="0" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td width="80">
					...
					<span style="display:none;" class="emissaoEditorDestinacaoEncalhe">Segmenta√ß√£o: </span>
				</td>
				<td width="210">
					...
					<!--
					&nbsp;&nbsp;&nbsp;
					Destina√ß√£o de Encalhe: <input type="checkbox" id="geracaoNfe-filtro-emissaoPorDestinacaoEncalhe" disabled="disabled" />
					-->
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				</select> &nbsp;At√© &nbsp; <select name="geracaoNfe-filtro-boxAte"
