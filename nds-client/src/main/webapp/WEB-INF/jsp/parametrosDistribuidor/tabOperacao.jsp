<div id="tabOperacao">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top">   
              <fieldset style="width:440px!important; margin-bottom:5px; float:left; margin-left:10px;">
              ...
              <table width="441" border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td align="center">&nbsp;</td>
                  <td width="139" align="center"><span class="bt_novos"><a href="javascript:;" onclick="parametrosDistribuidorController.gravarDiasDistribuidorFornecedor()" rel="tipsy" title="Incluir Novo Dia de Operação" ><img src="${pageContext.request.contextPath}/images/ico_add.gif" border="0" /></a></span></td>
                </tr>
              </table>
              <br />
                ...
                <table width="441" border="0" cellpadding="0" cellspacing="1">
                  ...
                  <c:forEach items="${listaDiaOperacaoFornecedor}" var="registroDiaOperacaoFornecedor">
                    <tr class="class_linha_1">
                      ...
                      <td width="28" align="center"><a href="javascript:;" onclick="parametrosDistribuidorController.excluirDiasDistribuidorFornecedor(${registroDiaOperacaoFornecedor.fornecedor.id})" ><img src="${pageContext.request.contextPath}/images/ico_excluir.gif" width="15" height="15" border="0" alt="Excluir" /></a></td>
                    </tr>
                    </c:forEach>
                </table>
              </span>
