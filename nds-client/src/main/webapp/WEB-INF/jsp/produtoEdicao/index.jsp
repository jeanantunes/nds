	...
	<div class="areaBts">
		<div class="area">
			...
			<span class="bt_novos" title="Adicionar em Lote">
				<a href="javascript:;" onclick="produtoEdicaoController.edicaoLote();" rel="tipsy" title="Adicionar Edi��o em Lote"><img src="${pageContext.request.contextPath}/images/ico_integrar.png" hspace="5" border="0" /></a>
			</span>
		</div>
	</div>
