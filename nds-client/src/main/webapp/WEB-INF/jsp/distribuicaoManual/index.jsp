  ...
  <tr>
    <td valign="top">
      <fieldset style=" width:380px; margin-top:5px; margin-left:20px">
        <legend>Dados da Publicação
          </legend><table width="376" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="106"><strong>Estudo:</strong></td>
              <td width="256" >2323232</td>
              </tr>
            <tr>
    ...
    <td valign="top">
      <fieldset style=" width:400px;">
        ...
        <span class="bt_novos"><a href="javascript:history.back(-1);"><img src="${pageContext.request.contextPath}/images/seta_voltar.gif" alt="Voltar" hspace="5" border="0" />Voltar</a></span>
                     ...
                     <span class="bt_novos"><a href="../Distribuicao/matriz_distribuicao.htm"><img src="${pageContext.request.contextPath}/images/ico_check.gif" alt="Confirmar" hspace="5" border="0" />Gerar Estudo</a></span>
