...
<script language="javascript" type="text/javascript">
	...
	//INCLUSÃƒO DE NOVA UNIFICAÃ‡ÃƒO SEM SAIR DO POPUP
...
#dialog-unificacao fieldset {width:440px!important;}
		   ...
		   <tr>
		     ...
		     <td width="254">
		         ...
		         <span name="botaoContrato" id="botaoContrato" class="bt_imprimir">
		             <!-- BOTAO PARA IMPRESSÃƒO DE CONTRATO - FUNÃ‡ÃƒO PROVISÃ“RIA ADICIONADA PARA POSTAR DADOS NA SESSAO -->
	...
	<div id="dialog-excluir-unificacao" title="UnificaÃ§Ã£o de Boletos">
	<fieldset>
		<legend>ExclusÃ£o de Unificalção de Boletos</legend>
