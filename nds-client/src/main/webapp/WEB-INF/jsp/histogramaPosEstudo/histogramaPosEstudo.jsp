...
<div class="corpo">
    ...
    <div class="container">
      ...
      <tr>
        <td width="423" rowspan="4" valign="top"><!--<span class="bt_novos" title="Gerar Arquivo"><a href="javascript:;"><img src="images/ico_excel.png" hspace="5" border="0" />Arquivo</a></span>-->
          ...
          <span class="bt_novos"><a href="javascript:;" onclick="popup_histograma();"><img src="images/ico_editar.gif" alt="Alterar Faixar" hspace="5" border="0" />Alterar Faixa</a></span>
          ...
          <span class="bt_novos"><a href="javascript:;" onclick="popup_divergencias();"><img src="images/ico_estudo_complementar.gif" alt="Divergências" hspace="5" border="0" />Base de estudo</a></span>
          <span class="bt_novos"><a href="javascript:;"><img src="images/ico_excluir.gif" alt="Excluir Estudo" hspace="5" border="0" />Excluir Estudo</a></span>
        ...
        <td width="41" style="border-bottom:1px solid #ccc;">200</td>
  ...
  <tr>
    ...
    <td width="60" style="border-bottom:1px solid #ccc;">200
      exs</td>
    <td width="60" style="border-bottom:1px solid #ccc;">200
      exs</td>
    </tr>
  <tr>
    ...
    <td style="border-bottom:1px solid #ccc;">2.5
      %</td>
    <td style="border-bottom:1px solid #ccc;">1.5
      %</td>
    </tr>
  <tr>
    ...
    <td style="border-bottom:1px solid #ccc;">200</td>
    <td colspan="3" style="border-bottom:1px solid #ccc;">Abrangência de Venda:&nbsp;&nbsp;20%</td>
    </tr>
</table>
       </fieldset>
</div>
