...
<div class="areaBts">
  <div class="area">
    ...
    <span class="bt_novos">
      <a href="javascript:;" rel='tipsy' title='Voltar' onclick="$('#workspace').tabs('remove', $('#workspace').tabs('option', 'selected')); selectTabTitle('Matriz Distribuição');" id="botaoVoltarMatrizDistribuicao">
