...
$(function() {
	...
	/**
	 * Renderiza componente de data de lan̤amento
	 */
	$(function() {
	...
	/**
	 * Efetua a pesquisa de resumo de expedi̵̤es, conforme tipo de pesquisa selecionado.
	 */
	function pesquisar () {
	...
	/**
	 * Efetua a busca das informa̵̤es referente a Produto, e monta grid
	 */
	...
	/**
	 * Efetua a busca das informa̵̤es referente a Box, e monta o grid
	 */
