  	...
  	<tr class="especialidades">
    	...
    	<fieldset style="height:280px; width:250px;">
     	...
     	<td width="69" align="center">
			<a id="linkDescontoEnviarTodos" href="javascript:;">
				<img border="0" height="30" width="39" src="${pageContext.request.contextPath}/images/seta_vai_todos.png"></a>
			<br><br>
			<a id="linkDescontoVoltarTodos" href="javascript:;">
				<img border="0" height="30" width="39" src="${pageContext.request.contextPath}/images/seta_volta_todos.png"></a>
			<br>
		</td>
