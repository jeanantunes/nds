      ...
      <tr class="linhas">
        ...
        <td width="374"><table width="348" border="0" cellspacing="1" cellpadding="2">
          ...
          <tr>
            <td>Cota:</td>
            <td>
            	<input type="text" name="cotaDTO.historicoSegundaCota" id="historicoSegundaCota" style="width:70px; margin-right:10px;" onblur="MANTER_COTA.validarCotaHistoricoBase('#historicoSegundaCota,#historicoSegundaPorcentagem')"/></td>
            <td align="center">%</td>
            <td>
          ...
          <tr>
            <td>Cota:</td>
            <td>
            	<input type="text" name="cotaDTO.historicoTerceiraCota" id="historicoTerceiraCota" style="width:70px; margin-right:10px;" onblur="MANTER_COTA.validarCotaHistoricoBase('#historicoTerceiraCota,#historicoTerceiraPorcentagem')" /></td>
            <td align="center">%</td>
            <td>
