				...
				<fieldset class="classFieldset" style="height:25px">
					<table width="950" border="0" cellspacing="1" cellpadding="1">
						<tr>
							...
							<td class="atalhosCE" width="150" bgcolor="#F8F8F8"><strong>F10</strong>-Ordenar Conferência por SM</td>
						</tr>
					</table>
				</fieldset>
			</div>
			...
			<table width="950" border="0" cellspacing="2" cellpadding="2" class="filtro">
				<tr>
					...
					<td width="121">
						...
						<input type="text" id="conferencia-numeroCota" name="conferencia-numeroCota" style="width: 80px; float: left; font-weight:bold; margin-right: 5px;" maxlength="6"/>
		...
		<fieldset class="fieldGrid">
			...
			<div class="grids" style="display: block; clear: left; margin-top: 10px;">
				...
				<table width="1000" border="0" cellspacing="1" cellpadding="1">
					<tr>
						<td width="77" align="center"><strong>Capa</strong></td>
				...
				<table width="1000" border="0" cellspacing="1" cellpadding="1">
					<tr>
						<td width="77" align="center"><strong>Desconto</strong></td>
						<td width="51"><strong>| Reparte:</strong></td>
