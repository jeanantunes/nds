  ...
  <tr>
    ...
    <fieldset>
      ...
      <tr style="background:#F8F8F8;">
        ...
        <td><a href="javascript:;" onclick="mostra_grid();"><img src="${pageContext.request.contextPath}/images/ico_negociar.png" border="0" /></a></td>
      </tr>
      <tr>
        <td>9999</td>
        <td>Viajar</td>
        <td>2345</td>
        <td align="center">322</td>
        <td><a href="javascript:;"><img src="${pageContext.request.contextPath}/images/ico_negociar.png" border="0" /></a></td>
      </tr>
    </table>
