		...
		<div class="container">
			...
			<fieldset class="classFieldset">
				...
				<table width="950" border="0" cellpadding="2" cellspacing="1"
					class="filtro">
					<tr>
						<td width="20"><input type="radio" name="pesqPor" id="radio"
							value="radio" onclick="areaInfluenciaGeradorFluxoController.filtroPorArea();" /></td>
						<td width="208">Área de Influência / Gerador de Fluxo</td>
						<td width="20"><input type="radio" name="pesqPor" id="radio2"
							value="radio" onclick="areaInfluenciaGeradorFluxoController.filtroPorCota();" /></td>
						<td width="33">Cota</td>
						<td width="643">
						<table width="642" border="0" cellpadding="2"
								...
								<tr>
									...
									<td width="104"><span class="bt_pesquisar"><a
											href="javascript:;" onclick="areaInfluenciaGeradorFluxoController.pesquisarPorCota();">Pesquisar</a></span></td>
								</tr>
							</table></td>
					</tr>
				</table>
				<table width="950" border="0" cellpadding="2" cellspacing="1"
					...
					<tr>
						...
						<td width="194"><select name="geradorFluxoSecundario" id="geradorFluxoSecundario"
							style="width: 180px;">
								<option selected="selected" value="0">Selecione...</option>
								<c:forEach items="${listaTipoGeradorFluxoPDV}" var="tipoGeradorFluxoPDV">
					      			<option value="${tipoGeradorFluxoPDV.key}">${tipoGeradorFluxoPDV.value}</option>	
					...
					<tr>
						...
						<td><span class="bt_pesquisar"><a href="javascript:;"
								onclick="areaInfluenciaGeradorFluxoController.pesquisarPorArea();">Pesquisar</a></span></td>
					</tr>
				</table>
			</fieldset>
			...
			<div class="grids" style="display: none;">
				...
				<div class="porArea" style="display: none;">
					<fieldset class="classFieldset">
						...
						<!-- EXPORTAR EXCEL -->
						<span class="bt_novos" title="Gerar Arquivo"><a href="${pageContext.request.contextPath}/distribuicao/areaInfluenciaGeradorFluxo/exportar?fileType=XLS">
						<img src="${pageContext.request.contextPath}/images/ico_excel.png" hspace="5" border="0" />Arquivo</a></span>

						<!-- EXPORTAR PDF -->
						<span class="bt_novos" title="Imprimir"><a href="${pageContext.request.contextPath}/distribuicao/areaInfluenciaGeradorFluxo/exportar?fileType=PDF">
						<img src="${pageContext.request.contextPath}/images/ico_impressora.gif" hspace="5" border="0" />Imprimir</a></span>
