...
LOAD DATA LOCAL INFILE '/opt/dumps/ARQCD08.NEW' INTO TABLE mov_cred COLUMNS TERMINATED BY '|' LINES TERMINATED BY '\n';

LOAD DATA LOCAL INFILE '/opt/dumps/ARQDB97.NEW' INTO TABLE mov_deb COLUMNS TERMINATED BY '|' LINES TERMINATED BY '\n';
