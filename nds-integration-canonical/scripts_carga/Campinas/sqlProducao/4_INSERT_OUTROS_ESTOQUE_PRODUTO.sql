...
-- Essa anomalia pode acontecer pq o arquivo HVND que popula o estoque produto pode não conter movimentos que estão na ESTQBOX 
-- (que insere movimentações de estoque baseados no PDV das cotas)
