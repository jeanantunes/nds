...
public class EMS0109Input extends IntegracaoDocument implements Serializable {
    ...
    public void setCodigoICD(final String codigoICD) {
     ...
     */
    public void setCodigoDistribuidor(final String codigoDistribuidor) {
     ...
     */
    public void setDataGeracaoArquivo(final Date dataGeracaoArquivo) {
     ...
     */
    public void setHoraGeracaoArquivo(final Date horaGeracaoArquivo) {
     ...
     */
    public void setMnemonicoTabela(final String mnemonicoTabela) {
     ...
     */
    public void setCodigoFornecedor(final Integer codigoFornecedor) {
     ...
     */
    public void setCodigoPublicacao(final String codigoPublicacao) {
     ...
     */
    public void setNomePublicacao(final String nomePublicacao) {
     ...
     */
    public void setPeb(final Integer peb) {
        this.peb = peb;
    }
     ...
     */
    public void setPacotePadrao(final Integer pacotePadrao) {
    ...
    public void setCondicaoTransmissaoHistograma(
            final String condicaoTransmissaoHistograma) {
     ...
     */
    public void setPorcentagemAbrangencia(final String porcentagemAbrangencia) {
     ...
     */
    public void setCondicaoLancamentoImediato(final String condicaoLancamentoImediato) {
     ...
     */
    public void setCondicaoPagamentoAntecipado(final String condicaoPagamentoAntecipado) {
     ...
     */
    public void setCondicaoPermissaoAlteracao(final String condicaoPermissaoAlteracao) {
     ...
     */
    public void setPercetualCobrancaAntecipada(final String percetualCobrancaAntecipada) {
     ...
     */
    public void setDiasCobrancaAntecipada(final String diasCobrancaAntecipada) {
     ...
     */
    public void setEspessura(final String espessura) {
     ...
     */
    public void setCriterio1SelecaoCota(final String criterio1SelecaoCota) {
     ...
     */
    public void setArgumento1Criterio1(final String argumento1Criterio1) {
     ...
     */
    public void setArgumento2Criterio1(final String argumento2Criterio1) {
     ...
     */
    public void setArgumento3Criterio1(final String argumento3Criterio1) {
     ...
     */
    public void setTipoCombinacao1(final String tipoCombinacao1) {
     ...
     */
    public void setCriterio2SelecaoCota(final String criterio2SelecaoCota) {
     ...
     */
    public void setArgumento1Criterio2(final String argumento1Criterio2) {
     ...
     */
    public void setArgumento2Criterio2(final String argumento2Criterio2) {
     ...
     */
    public void setArgumento3Criterio2(final String argumento3Criterio2) {
     ...
     */
    public void setTipoCombinacao2(final String tipoCombinacao2) {
     ...
     */
    public void setCriterio3SelecaoCota(final String criterio3SelecaoCota) {
     ...
     */
    public void setArgumento1Criterio3(final String argumento1Criterio3) {
     ...
     */
    public void setArgumento2Criterio3(final String argumento2Criterio3) {
     ...
     */
    public void setArgumento3Criterio3(final String argumento3Criterio3) {
     ...
     */
    public void setCodigoTributacaoFiscal(final String codigoTributacaoFiscal) {
     ...
     */
    public void setPeriodicidade(final Integer periodicidade) {
     ...
     */
    public void setCodigoHistograma(final String codigoHistograma) {
     ...
     */
    public void setTipoHistograma(final String tipoHistograma) {
     ...
     */
    public void setContextoEditor(final String contextoEditor) {
     ...
     */
    public void setCodigoEditor(final Long codigoEditor) {
     ...
     */
    public void setPercentualLimiteCotasFixadas(final String percentualLimiteCotasFixadas) {
    ...
    public void setPercentualLimiteFixacaoReparte(
            final String percentualLimiteFixacaoReparte) {
     ...
     */
    public void setSentidoAbrangencia(final String sentidoAbrangencia) {
     ...
     */
    public void setCodigoGrupoEditorial(final String codigoGrupoEditorial) {
     ...
     */
    public void setCodigoSubGrupoEditorial(final String codigoSubGrupoEditorial) {
    ...
    public boolean equals(final Object obj) {
        ...
        final EMS0109Input other = (EMS0109Input) obj;
        if (algoritmo == null) {
