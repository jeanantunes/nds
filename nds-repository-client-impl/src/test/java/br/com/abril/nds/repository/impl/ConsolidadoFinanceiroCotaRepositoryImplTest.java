...
public class ConsolidadoFinanceiroCotaRepositoryImplTest extends AbstractRepositoryImplTest {
	...
	public void setUp() {
		...
		ProdutoEdicao produtoEdicao = Fixture.produtoEdicao(234L, 12,1 , Long.valueOf(900), new BigDecimal(8), new BigDecimal(10), 
	...
	public void obterConsignadoCota(){
		...
		List<ConsignadoCotaDTO> lista = consolidadoFinanceiroRepository.obterMovimentoEstoqueCotaConsignado(filtro);
		Assert.assertEquals(0, lista.size());
	...
	public void obterVendaEncalhe(){
		...
		List<ConsultaVendaEncalheDTO> lista = consolidadoFinanceiroRepository.obterMovimentoVendaEncalhe(filtro);
		Assert.assertEquals(0, lista.size());
