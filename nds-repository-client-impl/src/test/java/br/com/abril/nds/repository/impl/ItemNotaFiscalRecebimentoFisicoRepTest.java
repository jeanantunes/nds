...
public class ItemNotaFiscalRecebimentoFisicoRepTest extends AbstractRepositoryImplTest{
	...
	public void setup() {
		...
		Produto produto = Fixture.produto("1", "Revista Veja", "Veja", PeriodicidadeProduto.SEMANAL, tipoProduto, 5, 5, Long.valueOf(10000), TributacaoFiscal. TRIBUTADO);
		...
		ProdutoEdicao produtoEdicao =
				Fixture.produtoEdicao(1L, 10, 14, Long.valueOf(100), BigDecimal.TEN, new BigDecimal(20), "ABCDEFGHIJKLMNOPQ", produto, null, false);		
		save(produtoEdicao);
