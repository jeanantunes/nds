...
public class EstudoCotaRepositoryImpl extends AbstractRepositoryModel<EstudoCota, Long> implements EstudoCotaRepository {
	...
	public List<EstudoCotaDTO> obterEstudoCotaPorDataProdutoEdicao(Long idLancamento, Long idProdutoEdicao) {
		...
		StringBuilder hql = new StringBuilder(" select estudoCota.id as id, ") 
			...
			.append(" CASE WHEN cota.parametrosCotaNotaFiscalEletronica is not null ")
			.append(" 		and (cota.parametrosCotaNotaFiscalEletronica.contribuinteICMS or cota.parametrosCotaNotaFiscalEletronica.exigeNotaFiscalEletronica) ")
			.append(" 	THEN cota.devolveEncalhe ELSE false END as cotaContribuinteExigeNotaFiscal, ")
