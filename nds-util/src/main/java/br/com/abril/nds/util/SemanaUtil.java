...
public class SemanaUtil {
	 ...
	 */
	public static int obterNumeroSemana(Date data, Integer diaInicioSemana) {
		
		Integer anoSemana = obterAnoNumeroSemana(data, diaInicioSemana);
		
		return getSemana(anoSemana);
	}
	...
	public static Date obterDataInicioSemana(Integer diaInicioSemana, Date data) {
