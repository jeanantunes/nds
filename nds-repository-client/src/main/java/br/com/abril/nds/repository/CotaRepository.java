...
public interface CotaRepository extends Repository<Cota, Long> {
	 ...
	 * Se for informado a lista de ProdutoEdicaoDTO, será considerado somente esses produtos e edições
	 * MÁXIMO 6 PRODUTOS
	 * 
...
public interface CotaRepository extends Repository<Cota, Long> {
	...
	List<AnaliseHistoricoDTO> buscarCotasComHistoricoDeVenda(List<ProdutoEdicaoDTO> listProdutoEdicaoDto, List<Cota> cotas, String sortorder, String sortname);
