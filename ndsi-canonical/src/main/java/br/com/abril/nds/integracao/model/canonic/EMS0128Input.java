...
@Record
public class EMS0128Input extends IntegracaoDocumentMaster<EMS0128InputItem> implements Serializable{
	...
	private List<EMS0128InputItem> item = new ArrayList<EMS0128InputItem>();
	 ...
	 * @return the item
	 */
	public List<EMS0128InputItem> getItem() {
		return item;
	}
	/**
	 * @param item the item to set
	 */
	public void setItem(List<EMS0128InputItem> item) {
		this.item = item;
	}
	@Override
