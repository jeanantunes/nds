 ...
 * @version 0.2
 */
public class TestCLCredComimCobrancaNaoRegistrada extends CampoLivreBaseTest{
	...
	public void setUp() throws Exception {
		...
		contaBancaria.setBanco(BancosSuportados.CREDCOMIM.create());
		contaBancaria.setAgencia(new Agencia(1349));
		contaBancaria.setNumeroDaConta(new NumeroDaConta(8));
