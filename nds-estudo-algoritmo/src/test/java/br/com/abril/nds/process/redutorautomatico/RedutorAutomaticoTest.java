...
public class RedutorAutomaticoTest {
    ...
    private Estudo criarAmbiente(boolean configurado, BigDecimal reparteDistribuir, BigDecimal vendaMedia, BigDecimal vendaEdicaoMaisRecenteFechada,
	    BigDecimal reparteCalculado, BigDecimal menorVenda) {
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(100), BigDecimal.valueOf(3), BigDecimal.valueOf(10), BigDecimal.ZERO,
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(100), BigDecimal.valueOf(3), BigDecimal.valueOf(20), BigDecimal.ZERO,
		BigDecimal.valueOf(5));
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(100), BigDecimal.valueOf(10), BigDecimal.ZERO, BigDecimal.valueOf(20),
		BigDecimal.valueOf(5));
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(110), BigDecimal.valueOf(10), BigDecimal.ZERO, BigDecimal.ZERO,
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.ZERO, BigDecimal.valueOf(100), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO);
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(100), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO);
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(100), BigDecimal.valueOf(70), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO);
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(100), BigDecimal.valueOf(50), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO);
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(100), BigDecimal.valueOf(90), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO);
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.valueOf(10), BigDecimal.valueOf(50), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO);
	...
	// Criação do ambiente
	Estudo estudo = criarAmbiente(true, BigDecimal.ZERO, BigDecimal.valueOf(50), BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO);
