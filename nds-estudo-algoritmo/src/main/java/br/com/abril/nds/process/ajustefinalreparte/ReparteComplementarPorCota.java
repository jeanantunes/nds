...
public class ReparteComplementarPorCota extends ProcessoAbstrato {
	...
	ordenadorList.add(new Ordenador("B") {
		...
		List<Long> cotasOrdenadaPorSegmentoSemEdicaoBase = rankingSegmentoDAO.getCotasOrdenadaPorSegmentoSemEdicaoBase(cList, getEstudo()
			.getEdicoesBase());
	    }
	});
	...
	// 1) Listar todas as cotas ativas que n�o entraram no Estudo Normal, considerando-se as exclus�es por CLASSIFICA��O,
	// SEGMENTO e MIX;
	 ...
	 * se a distribuicao for por multiplos ate acabar o reparte complementar, sempre considerando-se a prioriza��o acima. Caso
	 * haja saldo a distribuir e todas as bancas selecionadas j� receberam, enviar 1 exemplar ou 1 pacote-padr�o se a
