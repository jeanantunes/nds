...
@Repository
public class ParametrosFTFGeracaoRepositoryImpl extends AbstractRepositoryModel<ParametroSistema, Long> implements ParametroSistemaRepository {

	public ParametrosFTFGeracaoRepositoryImpl() {
