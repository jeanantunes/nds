...
//	private Map<String, Lancamento> mapLancamentosParaUpdate;
	...
	// ================================================================================
	/**
	 * M�todo utilizado para inicializar todos os objetos da Janela.
	 * 
	 * @author Andr� W da Silva
	 * @since 1.0
	 * @param Nothing
...
//		}
	...
	/**
	 * Metodo utliziado para desabilitar os objetos da tela que n�o devem ser
	 * manipulado quando um lan�amento n�o foi carregado.
	 * 
	 * @author Andre W Silva
	 * @since 1.0
	 */
