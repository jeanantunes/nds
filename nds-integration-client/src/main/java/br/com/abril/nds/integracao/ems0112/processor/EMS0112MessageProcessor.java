		...
		if (null != ed) {
			...
			if(ed.getTipoEndereco() == TipoEndereco.COMERCIAL){
				...
				if(!input.getNumeroEditor().equals(ed.getEndereco().getNumero())){
					...
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do Número Endereco para "+ed.getEndereco().getNumero());
				}
				...
				if(!input.getComplementoEditor().equals(ed.getEndereco().getComplemento())){
					...
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do Complemento para "+ed.getEndereco().getComplemento());
				}
				...
				if(!input.getTipoLogradouroEditor().equals(ed.getTipoEndereco().toString())){
					...
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do Tipo Endereço para "+ed.getTipoEndereco().toString());
				}

				if(!input.getLogradouroEditor().equals(ed.getEndereco().getLogradouro())){
					ed.getEndereco().setLogradouro(input.getLogradouroEditor());
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do Logradouro para "+ed.getEndereco().getLogradouro());
				}

				if(!input.getCidadeEditor().equals(ed.getEndereco().getCidade())){
					ed.getEndereco().setCidade(input.getCidadeEditor());
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização da Cidade para "+ed.getEndereco().getCidade());
				}

				if(!input.getUfEditor().equals(ed.getEndereco().getUf())){
					ed.getEndereco().setUf(input.getUfEditor());
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização da Sigla UF para "+ed.getEndereco().getUf());
				}

				if(!input.getCepEditor().equals(ed.getEndereco().getCep())){
					ed.getEndereco().setCep(input.getCepEditor());
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do CEP para "+ed.getEndereco().getCep());
				}

				if(!input.getBairroEditor().equals(ed.getEndereco().getBairro())){
					ed.getEndereco().setBairro(input.getBairroEditor());
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do Bairro para "+ed.getEndereco().getBairro());
				}						
				...
				if(!input.getBairroEntrega().equals(ed.getEndereco().getBairro())){
					...
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do Código Bairro para "+ed.getEndereco().getBairro());
				}
		...
		if (null != telefone) {
			if(telefone.getTipoTelefone() == TipoTelefone.FAX){
				...
				if(!input.getDddFax().equals(telefone.getTelefone().getDdd())) {
					...
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do DDD (Fax) para "+telefone.getTelefone().getDdd());
				}
				
				if(!input.getTelefoneFax().equals(telefone.getTelefone().getNumero())) {
					telefone.getTelefone().setNumero(input.getTelefoneFax());
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do Número (Fax) para "+telefone.getTelefone().getNumero());
				}
				...
				if(!input.getDddEditor().equals(telefone.getTelefone().getDdd())) {
					...
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do DDD Principal para "+telefone.getTelefone().getDdd());
				}
				
				if(!input.getTelefoneEditor().equals(telefone.getTelefone().getNumero())) {
					telefone.getTelefone().setNumero(input.getTelefoneEditor());
					ndsiLoggerFactory.getLogger().logInfo(message, EventoExecucaoEnum.INF_DADO_ALTERADO, "Atualização do Número Principal para "+telefone.getTelefone().getNumero());
				}
