...
/**
 * Entidade base para os endereços utilizados no
 ...
 */
@MappedSuperclass
public class HistoricoTitularidadeEndereco implements Serializable {
     ...
     */
    @Column(name = "CODIGO_CIDADE_IBGE", length = 7)
