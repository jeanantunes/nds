...
@Exportable
public class FiltroFollowupCadastroParcialDTO  extends FiltroDTO implements Serializable  {
	...
	public FiltroFollowupCadastroParcialDTO() {}
	
	public FiltroFollowupCadastroParcialDTO(Date dt, String paramsd) {
