...
@Record
public class Ems0107Deajo implements Serializable {
	...
	@Field(offset = 17, length = 8, align = Align.RIGHT, paddingChar = '0')
	...
	@Field(offset = 25, length = 1, align = Align.RIGHT, paddingChar = '0')
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Ems0107Deajo other = (Ems0107Deajo) obj;
		if (codigoCota == null) {
