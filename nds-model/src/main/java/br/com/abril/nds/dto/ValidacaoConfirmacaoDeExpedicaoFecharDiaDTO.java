...
@Exportable
public class ValidacaoConfirmacaoDeExpedicaoFecharDiaDTO implements Serializable {
	...
	private String inconsistencia = "Produto não confirmado para expedição, necessário reprogramar no Balanceamento da Matriz de Lançamento";
