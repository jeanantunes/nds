...
public class ProdutoServico implements Serializable {
	...
	@NFEExport(secao=TipoSessao.I, posicao=0, tamanho=60)
	...
	@NFEExports({@NFEExport(secao=TipoSessao.I, posicao=1, tamanho=14), @NFEExport(secao=TipoSessao.I, posicao=11, tamanho=14)})
	...
	@NFEExport(secao=TipoSessao.I, posicao=2, tamanho=120)
	...
	@NFEExport(secao=TipoSessao.I, posicao=3, tamanho=8)
	private Long ncm;
	...
	@NFEExport(secao=TipoSessao.I, posicao=4, tamanho=3)
	private Long extipi;
	...
	@NFEExport(secao=TipoSessao.I, posicao=6, tamanho=4)
	...
	@NFEExports({@NFEExport(secao=TipoSessao.I, posicao=7, tamanho=6),@NFEExport(secao=TipoSessao.I, posicao=12, tamanho=6)})
	...
	@NFEExports({@NFEExport(secao=TipoSessao.I, posicao=8, tamanho=12),@NFEExport(secao=TipoSessao.I, posicao=13, tamanho=12)})
	...
	@NFEExports({@NFEExport(secao=TipoSessao.I, posicao=9, tamanho=16),@NFEExport(secao=TipoSessao.I, posicao=14, tamanho=16)})
	...
	@NFEExport(secao=TipoSessao.I, posicao=15, tamanho=15)
	...
	@NFEExport(secao=TipoSessao.I, posicao=16, tamanho=15)
	...
	@NFEExport(secao=TipoSessao.I, posicao=17, tamanho=15)
