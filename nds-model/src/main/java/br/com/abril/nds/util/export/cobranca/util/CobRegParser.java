...
public final class CobRegParser {

	private boolean trace;
	
	private static Logger LOGGER = LoggerFactory.getLogger(CobRegParser.class);
	
	public CobRegParser() {
		
	}
	
	public CobRegParser(boolean debug) {
		this.trace = debug;
	}
	
	@SuppressWarnings("all")
	public void parseCobrancaReg(CobRegBaseDTO cobRegBaseDTO, BufferedWriter parser) throws Exception {
		
		Class<? extends CobRegBaseDTO> c = cobRegBaseDTO.getClass();
		...
		for (Field field:fields) {
			...
			for (Annotation annot: annotations) {
				...
				if (annot instanceof CobRegfield) {
					...
					Object obj = getter.invoke(cobRegBaseDTO, null);
	...
	@SuppressWarnings("all")
	public String parseArquivo(CobRegBaseDTO cobRegBaseDTO) throws Exception {
