...
public enum Permissao {
    ...
    ROLE_RECOLHIMENTO_CONSULTA_BASE_ENCALHE_COTA_ALTERACAO("Consulta Base Encalhe",    						Permissao.ROLE_RECOLHIMENTO, true),
    ROLE_RECOLHIMENTO_CONSULTA_BASE_ENCALHE_COTA("Consulta Base Encalhe",    								Permissao.ROLE_RECOLHIMENTO, ROLE_RECOLHIMENTO_CONSULTA_BASE_ENCALHE_COTA_ALTERACAO, true, null),
