...
public enum Permissao {
    ...
    ROLE_RECOLHIMENTO_CONSULTA_BASE_ENCALHE_COTA_ALTERACAO("Consulta Encalhe Base Reparte",    						Permissao.ROLE_RECOLHIMENTO, true),
    ROLE_RECOLHIMENTO_CONSULTA_BASE_ENCALHE_COTA("Consulta Encalhe Base Reparte",    								Permissao.ROLE_RECOLHIMENTO, ROLE_RECOLHIMENTO_CONSULTA_BASE_ENCALHE_COTA_ALTERACAO, true, null),
