...
public enum Permissao
{
	...
	ROLE_NFE_RETORNO_NFE("NF-e",																	  	   Permissao.ROLE_DEVOLUCAO),
	ROLE_NFE_CONSULTA_NFE_ENCALHE_TRATAMENTO("Consulta NF-e Encalhe Tratamento",						   Permissao.ROLE_DEVOLUCAO),
	ROLE_NFE_PAINEL_MONITOR_NFE("Painel Monitor NF-e",													   Permissao.ROLE_DEVOLUCAO),
	...
	ROLE_ADMINISTRACAO_TIPO_DESCONTO_COTA("Tipo Desconto da Cota",								  		   Permissao.ROLE_ADMINISTRACAO),
	...
	ROLE_ADMINISTRACAO_TIPO_PRODUTO("Tipo de Produto",				          					 		   Permissao.ROLE_ADMINISTRACAO),
