...
public enum Permissao {
	...
	ROLE_DISTRIBUICAO_CARACTERISTICA_DISTRIBUICAO("Características de Distribuição",                        Permissao.ROLE_DISTRIBUICAO, ROLE_DISTRIBUICAO_CARACTERISTICA_DISTRIBUICAO_ALTERACAO, true),
