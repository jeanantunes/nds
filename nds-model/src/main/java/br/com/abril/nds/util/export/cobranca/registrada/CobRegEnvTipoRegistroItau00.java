...
public class CobRegEnvTipoRegistroItau00 extends CobRegBaseDTO {
	...
	@CobRegfield(tamanho = 7, tipo="char", ordem=7)
	private String contaCliente;
	
	@CobRegfield(tamanho = 1, tipo="char", ordem=8)
	private String digitoConta;
	
	@CobRegfield(tamanho=8, tipo="char", ordem=9)
	private String filler2;
	
	@CobRegfield(tamanho = 30, tipo="char", ordem=10)
	...
	@CobRegfield(tamanho = 3, tipo="char", ordem=14)
	private String codigoUsuario;
	
	@CobRegfield(tamanho = 291, tipo="char", ordem=15)
