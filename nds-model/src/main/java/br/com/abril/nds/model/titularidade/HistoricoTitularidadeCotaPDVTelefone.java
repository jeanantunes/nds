...
/**
 * Entidade para armazenamento dos telefones
 * do PDV no histórico de titularidade da
 * cota
 * 
 ...
 */
@Entity
@Table(name = "HISTORICO_TITULARIDADE_COTA_PDV_TELEFONE")
@SequenceGenerator(name = "HIST_TIT_COTA_PDV_TELEFONE_SEQ", initialValue = 1, allocationSize = 1)
public class HistoricoTitularidadeCotaPDVTelefone extends
        HistoricoTitularidadeTelefone {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(generator = "HIST_TIT_COTA_PDV_TELEFONE_SEQ")
    @Column(name = "ID")
    private Long id;
