...
(SELECT
'ENTRADA' AS NOTAS_DE,
NOTA_FISCAL_ENTRADA.ID as NOTA_FISCAL_ID,
PESSOA_COTA.ID AS PESSOA_ID,
...
INNER JOIN PESSOA AS PESSOA_COTA ON (
    COTA.PESSOA_ID = PESSOA_COTA.ID
)

WHERE

NOTA_FISCAL_ENTRADA.EMITIDA = 1
)
UNION
(
SELECT
...
SELECT  
'SAIDA' AS NOTAS_DE,
NOTA_FISCAL_SAIDA.ID as NOTA_FISCAL_ID,
PESSOA_FORNECEDOR.ID AS PESSOA_ID,
