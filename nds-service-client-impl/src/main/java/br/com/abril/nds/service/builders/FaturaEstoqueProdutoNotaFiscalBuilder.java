...
public class FaturaEstoqueProdutoNotaFiscalBuilder {
	public static void montarFaturaEstoqueProdutoNotaFiscal (br.com.abril.nds.model.fiscal.nfe.NotaFiscalNds notaFiscal, List<EstoqueProduto> estoquesProdutos){
