...
public class DiferencaEstoqueServiceImpl implements DiferencaEstoqueService {
    ...
    public void efetuarAlteracoes(Set<Diferenca> listaNovasDiferencas,
        ...
        final Origem origem  = (mapaRateioCotas!= null && mapaRateioCotas.size() > 0) ? Origem.TRANSFERENCIA_LANCAMENTO_FALTA_E_SOBRA_COTA  : null;
...
Set<DiferencaVO> listaNovaDiferencaVO,
            final DiferencaVO diferencaVO) {
        if (listaNovaDiferencaVO == null) {
            listaNovaDiferencaVO = new HashSet<DiferencaVO>();
        }
