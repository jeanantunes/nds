			...
			if (det.getSequencia() != null && !det.getSequencia().equals("")) {
				...
				if (det.getProdutoServico() != null && !det.getProdutoServico().getCodigoProduto().isEmpty()) {
					h.append("I|")
							...
							.append(CurrencyUtil.arredondarValorParaDuasCasas(det.getProdutoServico().getValorUnitario())).append("|")
							.append(CurrencyUtil.arredondarValorParaQuatroCasas(det.getProdutoServico().getValorTotalBruto())).append("|")
							.append("").append("|")
							.append(det.getProdutoServico().getUnidade()).append("|")
							// qTrib
							.append(det.getProdutoServico().getQuantidade()).append("|")
