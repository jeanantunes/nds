...
LOAD DATA INFILE '/opt/rollout/load_files/normal_nds_2015_jul.txt' INTO TABLE HVND_MDC COLUMNS TERMINATED BY '|' LINES TERMINATED BY '|\r\n';
LOAD DATA INFILE '/opt/rollout/load_files/normal_nds_2015_ago.txt' INTO TABLE HVND_MDC COLUMNS TERMINATED BY '|' LINES TERMINATED BY '|\r\n';
LOAD DATA INFILE '/opt/rollout/load_files/normal_nds_2015_1.txt' INTO TABLE HVND_MDC COLUMNS TERMINATED BY '|' LINES TERMINATED BY '|\r\n';
