...
#echo Copiando arquivos de $DIRBKP/$S1/cargas/20150822/DISTRIBUIDOR/

#echo Para $DIRBKP/load_files

#sleep 10s

cd $DIRBKP/$S1/cargas/20150822
...
echo 
echo '13) Publica base SAO PAULO no RDS de Producao' `date +%T`
...
#echo
#echo '14) Publica base SAO PAULO no RDS de Producao.' `date +%T`
