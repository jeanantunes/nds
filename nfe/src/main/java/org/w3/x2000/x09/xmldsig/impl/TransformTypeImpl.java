...
public class TransformTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x2000.x09.xmldsig.TransformType
{
     ...
     */
    public org.w3.x2000.x09.xmldsig.TTransformURI xgetAlgorithm()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x2000.x09.xmldsig.TTransformURI target = null;
            target = (org.w3.x2000.x09.xmldsig.TTransformURI)get_store().find_attribute_user(ALGORITHM$2);
            return target;
        }
    }
     ...
     */
    public void xsetAlgorithm(org.w3.x2000.x09.xmldsig.TTransformURI algorithm)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.w3.x2000.x09.xmldsig.TTransformURI)get_store().add_attribute_user(ALGORITHM$2);
            }
