...
public class ReferenceTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x2000.x09.xmldsig.ReferenceType
{
     ...
     */
    public org.w3.x2000.x09.xmldsig.ReferenceType.DigestMethod getDigestMethod()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x2000.x09.xmldsig.ReferenceType.DigestMethod target = null;
            target = (org.w3.x2000.x09.xmldsig.ReferenceType.DigestMethod)get_store().find_element_user(DIGESTMETHOD$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDigestMethod(org.w3.x2000.x09.xmldsig.ReferenceType.DigestMethod digestMethod)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.w3.x2000.x09.xmldsig.ReferenceType.DigestMethod)get_store().add_element_user(DIGESTMETHOD$2);
            }
     ...
     */
    public org.w3.x2000.x09.xmldsig.ReferenceType.DigestMethod addNewDigestMethod()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.w3.x2000.x09.xmldsig.ReferenceType.URI xgetURI()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x2000.x09.xmldsig.ReferenceType.URI target = null;
            target = (org.w3.x2000.x09.xmldsig.ReferenceType.URI)get_store().find_attribute_user(URI$8);
            return target;
        }
    }
     ...
     */
    public void xsetURI(org.w3.x2000.x09.xmldsig.ReferenceType.URI uri)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.w3.x2000.x09.xmldsig.ReferenceType.URI)get_store().add_attribute_user(URI$8);
            }
            target.set(uri);
        }
    }
