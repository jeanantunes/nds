...
ALTER TABLE natureza_operacao ADD COLUMN DISTRIBUIDOR_NOTA_FISCAL_TIPO_ID BIGINT(20) NOT NULL AFTER CFOP_OUTROS_ESTADOS;

ALTER TABLE natureza_operacao DROP COLUMN DISTRIBUIDOR_NOTA_FISCAL_TIPO_ID;
...
ALTER TABLE natureza_operacao  ADD COLUMN GERAR_NOTAS_REFERENCIADAS TINYINT(1) NOT NULL AFTER GERAR_COTA_NAO_EXIGE_NFE;
...
-- produto add column
ALTER TABLE produto ADD COLUMN REMESSA_DISTRIBUICAO TINYINT(1) NULL DEFAULT '0' AFTER geracao_automatica;
...
-- saber qual natureza de operação incide os tributos
CREATE TABLE natureza_operacao_tributo (
  NATUREZA_OPERACAO_ID bigint(20) NOT NULL,
  TRIBUTO_ID bigint(20) NOT NULL,
  PRIMARY KEY (NATUREZA_OPERACAO_ID, TRIBUTO_ID),
  KEY FK_tributo_id (TRIBUTO_ID),
  CONSTRAINT FK_tributo_id_2 FOREIGN KEY (TRIBUTO_ID) REFERENCES TRIBUTOS (ID),
  CONSTRAINT FK_natureza_operacao_tributo FOREIGN KEY (NATUREZA_OPERACAO_ID) REFERENCES NATUREZA_OPERACAO (ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
