...
‎ 
ALTER TABLE nota_fiscal_valor_calculado ADD COLUMN VALOR_ICMS_DESON DECIMAL(18,4) NULL  AFTER VALOR_ICMS ;

insert into parametro_sistema (ID, TIPO_PARAMETRO_SISTEMA, VALOR) values('59','NFE_PATH_CERTIFICADO','/opt/certificado/');
