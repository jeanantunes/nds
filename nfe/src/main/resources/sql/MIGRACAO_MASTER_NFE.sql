...
ALTER TABLE `nds_lab1`.`nota_envio` CHANGE COLUMN `NOTA_FISCAL_ID` `NOTA_FISCAL_ID` BIGINT(20) NULL DEFAULT NULL  ;‏
‎ 
ALTER TABLE `telesena`.`nota_fiscal_novo` ADD COLUMN `INDICADOR_DESTINATARIO` BIGINT(11) NULL  AFTER `ENDERECO_ID_EMITENTE` ;‏
‎ 
ALTER TABLE `telesena`.`nota_fiscal_valor_calculado` ADD COLUMN `VALOR_ICMS_DESON` DECIMAL(18,4) NULL  AFTER `VALOR_ICMS` ;