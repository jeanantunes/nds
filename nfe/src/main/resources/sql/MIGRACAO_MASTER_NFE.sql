...
-- produto add column
ALTER TABLE produto ADD COLUMN REMESSA_DISTRIBUICAO TINYINT(1) NULL  AFTER geracao_automatica , ADD COLUMN produtocol VARCHAR(45) NULL DEFAULT '0'  AFTER SUB_GRUPO_EDITORIAL;
